...
srun python val.py --img 320 --batch 16 --weights /work/u5832291/yixian/yolov5_edit/runs/train/YOLOv5X_m3fd_tardal_dt_fused_shipped_20231212/weights/best.pt --data m3fd_tardal_dt_fused_shipped.yaml --device 0 --verbose --task val --conf-thres 0.001 --save-txt --save-conf --name YOLOv5X_m3fd_tardal_dt_fused_shipped_20231212
